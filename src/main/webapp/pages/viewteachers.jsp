...
<body>
    ...
    <div class="form">
       <form:form class="login-form" method="POST" action="/admin/viewteachers"
     ...
     <tbody>
         ...
         <tr>
             ...
             <td>${teacher.bus_no}</td>
                ...
                <td><a href="/admin/assignsubject/${teacher.id}">Assign Subject</a></td>
                
              	<td><a href="/admin/editteacher/${teacher.id}">Edit</a></td>
   			   <td><a href="/admin/deleteteacher/${teacher.id}">Delete</a></td>
         </tr>
         </c:forEach>   
     </tbody>
 </table>
