...
<body>
    ...
    <div class="form">
       <form:form class="login-form" method="POST" action="/admin/viewstudents"
         ...
         <tr>
             ...
             <td>${student.contact_no}</td>
              <td>${student.address}</td>
              	<td><a href="/admin/editStudent/${student.adm_no}">Edit</a></td>
   			   <td><a href="/admin/deleteStudent/${student.adm_no}">Delete</a></td>
         </tr>
         </c:forEach>   
     </tbody>
 </table>
