...
<body>
    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="ftco-nav">
        ...
        <div class="cap" > Edit Student Profile</div>
      	<form:form method="post" modelAttribute="student" action="/admin/editStudent/${student.adm_no}">
		
		<table id="customers">
		
		 <form:hidden path="adm_no"/> <form:errors path="adm_no"/>
	<%--	<form:hidden path="middle_name"/> <form:errors path="middle_name"/> --%>
		...
		<tr><td>First Name</td>
		<td>
		<form:input path="first_name" type="text" value="${student.first_name}" required="required"/> </td><!-- bind to user.name-->
		<td><form:errors path="first_name" /></td></tr>
		
		<tr><td>Middle Name</td>
		<td>
		<form:input path="middle_name" type="text" value="${student.middle_name}"/> </td><!-- bind to user.name-->
		<td><form:errors path="middle_name" /></td></tr>
		
		<tr><td>Last Name</td>
		<td>
		<form:input path="last_name" type="text" value="${student.last_name}"/> </td><!-- bind to user.name-->
		<td><form:errors path="last_name" /></td></tr>
		
		<tr><td>Class</td>
		<td>
		<form:input path="class_id" type="text" value="${student.class_id}" required="required" /> </td><!-- bind to user.name-->
		<td><form:errors path="class_id" /></td></tr>
		
		
		<tr><td>Roll no</td>
		<td>
		<form:input path="roll_no" type="text" value="${student.roll_no}" required="required"/> </td><!-- bind to user.name-->
		<td><form:errors path="roll_no" /></td></tr>
		...
		<tr><td>School</td>
		<td>
		<form:input path="school_id" type="integer" value="${student.school_id}" required="required"/> </td><!-- bind to user.name-->
		<td><form:errors path="school_id" /></td></tr>
		<tr><td>Bus No.</td>
		<td>
		<form:input path="bus_no" type="integer" value="${student.bus_no}" /> </td><!-- bind to user.name-->
		...
		<td>
		<form:input path="dob" type="date" value="${student.dob}" required="required"/> </td><!-- bind to user.name-->
