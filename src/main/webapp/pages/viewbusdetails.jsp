...
<body>
    ...
    <div class="form">
       <form:form class="login-form" method="POST" action="/admin/viewbusdetails"
       	modelAttribute="schooldetail">
       	<div class = "form-div">
       	<div class="custom-select" id="select-school">
       	 <select name="school_id">
       	 <option value=0>Select School</option>
       	      <option value=1>LFCS SIKATIA MAU</option>
			  <option value=2>LFCS MAIN BRANCH MAU</option>
			  <option value=3>LFCS BALLIA</option>
			  <option value=4>LFCS GHOSI MAU</option>
			  <option value=5>LFIS MAU</option>
     ...
     <tbody>
         ...
         <tr>
           ...
           <td>${bus.bus_no}</td>
             ...
             <td>${bus.drivercontactno}</td>
             <td>${bus.route_string}</td>
           
              	<td><a href="/admin/viewbususers/${bus.bus_no}">View Students</a></td>
   			   <td><a href="/admin/deletebus/${bus.bus_no}">Delete</a></td>
         </tr>
         </c:forEach>   
     </tbody>
 </table>
