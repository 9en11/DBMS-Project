     ...
     <tbody>
         ...
         <tr>
           ...
           <td>${fee.month_name}</td>
             ...
             <td><c:if test="${fee.fee_status!=false}"> &#9989</c:if>
             <c:if test="${fee.fee_status==false}"> &#10060;</c:if>
            
             </td>
             
              <sec:authorize access="hasRole('ADMIN')">
              <td><a href="/admin/feestatus/${fee.adm_no }/${fee.fee_id}">pay</a></td>
              </sec:authorize>
